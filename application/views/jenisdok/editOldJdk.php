            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>editJenisDok" method="post" id="editJenisDok" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="kode">Kode</label>
                                        <input type="text" class="form-control" id="kode" placeholder="Kode" name="kodeDok" value="<?php echo $kodeDok; ?>" maxlength="10">
                                    </div>
                                </div>
                                <div class="col-md-6">                                
                                    <div class="form-group">
